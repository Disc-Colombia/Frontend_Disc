...
const CookiesPolicy = () => {
  return (
    <div className="container_cookiespolicy">
      <div className="cookies_policy--content">
        ...
        <section>
          ...
          <p>
            ...
            etc.) cuando visitas un sitio web. Ayudan a los sitios web a
            recordar información sobre tu visita, como tu idioma preferido u
            otras configuraciones, lo que facilita tu próxima visita y hace que
            el sitio te sea más útil.{" "}
          </p>{" "}
          <p>
            2. Tipos de cookies que utilizamos Utilizamos diferentes tipos de
            cookies para varios propósitos. A continuación se explica cada una
            de las categorías: Cookies necesarias: Estas cookies son esenciales
            para que el sitio web funcione correctamente. Incluyen cookies que
            te permiten iniciar sesión en áreas seguras del sitio. Cookies de
          ...
          <p>
            {" "}
            4. Gestión de las cookies Puedes controlar y gestionar las cookies
            de diversas formas. La mayoría de los navegadores te permiten
            bloquear o eliminar cookies. A continuación se incluyen enlaces a
            guías para gestionar las cookies en los navegadores más comunes:
            Google Chrome Mozilla Firefox Apple Safari Microsoft Edge Ten en
            cuenta que bloquear las cookies podría afectar tu experiencia en
            nuestro sitio web.
          </p>{" "}
          <p>
            {" "}
            ...
            publicidad. Por ejemplo, utilizamos Google Analytics para rastrear
            el tráfico y el comportamiento de los usuarios en nuestro sitio.
          </p>{" "}
          <p>
            {" "}
            6. Cambios en esta Política de Cookies Podemos actualizar esta
            Política de Cookies de vez en cuando. Cualquier cambio será
            publicado en esta página con una nueva fecha de "Última
            actualización".
          </p>{" "}
          <p>
            {" "}
