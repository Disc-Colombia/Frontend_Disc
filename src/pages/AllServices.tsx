...
import serviciosHumanoswebp from "../imgs/servicios_humanos_11zon.webp";
import consultoriaIT from "../imgs/consultoria_IT.png";
import consultoriaITwebp from "../imgs/consultoria_IT_001.webp";
import seguridadciber from "../imgs/seguridad_cibernetica.png";
import seguridadciberwebp from "../imgs/seguridad_cibernetica_11zon.webp";
import soluciones from "../imgs/soluciones_financieras.png";
import solucioneswebp from "../imgs/soluciones_financieras_11zon.webp";
import serviciocliente from "../imgs/servicio_al_cliente.png";
import servicioclientewebp from "../imgs/servicio_al_cliente_11zon.webp";
      ...
      <div className="container_items--allservices">
        <div className="image-grid--allservices">
          <div className="image-item">
            ...
            <h2 className="tittle_all--items">
              Human Service & Healthcare Systems Administration
            </h2>

            <p className="paragraph_all--items">
          ...
          <div className="image-item">
            <picture>
              <source srcSet={consultoriaITwebp} type="image/webp" />
              <img loading="lazy" src={consultoriaIT as string} alt="consultoria IT" />
            </picture>
            <h2 className="tittle_all--items">IT Consulting</h2>
            <p className="paragraph_all--items">
              IT resources can be scarce. DISC provides a full range of
              expertise to help your company function fluidly. Our team of
              experts can provide everything from staff augmentation to
          ...
          <div className="image-item">
            <picture>
              <source srcSet={seguridadciberwebp} type="image/webp" />
              <img loading="lazy" src={seguridadciber as string} alt="Cybersecurity" />
            </picture>
            <h2 className="tittle_all--items">Cybersecurity</h2>
            <p className="paragraph_all--items">
              DISC provides the most comprehensive data coverage of any major
              platform for monitoring and detecting threats across digital
              channels (i.e. web, mobile, virtualization security, AI
              Automation, security assessments, etc.) and provides real-time
            ...
            <ul className="list-services">
              ...
              <li>
                Incident time, browser type, and behavior triggering malicious
                activity
              </li>
        ...
        <div className="image-gridsec--allservices">
          <div className="image-item">
            <picture>
              <source srcSet={solucioneswebp} type="image/webp" />
              <img loading="lazy" src={soluciones as string} alt="Finance Solutions" />
            </picture>
            <h2 className="tittle_all--items">Finance Solutions</h2>
            <p className="paragraph_all--items">
              DISC is the premier provider for outsourced accounting support and
              consulting for billing, reporting, and revenue management.
            </p>
            <ul className="list-services">
          ...
          <div className="image-item">
            <picture>
              <source srcSet={servicioclientewebp} type="image/webp" />
              <img loading="lazy" src={serviciocliente as string} alt="Customer Service" />
            </picture>
            <h2 className="tittle_all--items">Customer Service</h2>
            <p className="paragraph_all--items">
              From call center support to help desk operators, DISC ensures that
              every client interaction reflects a positive,personable, and
